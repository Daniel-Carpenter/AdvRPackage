...
To print the `Rttest` object, use the `print()` function. You will find the confidence level, interval, and original sample data used:
...
To print the `Rttest` object, use the `print()` function as seen before. You will find the confidence level, interval, and original sample data used:
